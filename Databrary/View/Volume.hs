...
htmlVolumeView :: Volume -> AppRequest -> H.Html
...
htmlVolumeEdit :: Maybe (Volume, Maybe Citation) -> AppRequest -> FormHtml f
...
htmlVolumeLinksEdit :: Volume -> [Citation] -> AppRequest -> FormHtml f
...
htmlVolumeSearch :: VolumeFilter -> [Volume] -> AppRequest -> FormHtml f
